...
<div class="w3-bar w3-theme">
  ...
  <a href="/petro/contactdetails.php" class="w3-bar-item w3-button testbtn w3-padding-16" style="background-color: #005960;">Contact Details</a>
 ...
 <div id="Paris" class="w3-container city w3-animate-opacity">
    ...
    <form class="w3-container w3-card-4" action="insert.php" method="post" id="myform" >
      ...
      <div class="w3-section">      
        <input class="w3-input" type="text" name="addressline1" id="addressline1" onkeyup='saveValue(this);'>
        <label>Address Line 1</label>
      </div>
      <div class="w3-section">      
        <input class="w3-input" type="text" name="addressline2" id="addressline2" onkeyup='saveValue(this);'>
        <label>Address Line 2</label>
      </div>
      <div class="w3-section">
      <div class="w3-third">
        <input class="w3-input" type="text" name="city" style="width: 200px;" id="city" onkeyup='saveValue(this);' >
        <label>City</label>
      </div>
      <div class="w3-third">
        <input class="w3-input" type="text" name="state" style="width: 200px;" id="state" onkeyup='saveValue(this);' >
        <label>State</label>
      </div>
      <div class="w3-third">
        <input class="w3-input" type="text" name="zipcode" style="width: 200px;" id="zipcode" onkeyup='saveValue(this);'>
        <label>ZIP Code</label>
      </div>
      </div>
      <div class="w3-section">
      <div class="w3-third">
        <input class="w3-input" type="text" name="telephone" style="width: 200px;" id="telephone" onkeyup='saveValue(this);' >
        <label>Telephone</label>
      </div>
      <div class="w3-third">
        <input class="w3-input" type="text" name="mobile" style="width: 200px;" id="mobile" onkeyup='saveValue(this);'>
        <label>Mobile</label>
        <br><br><br>
      ...
      <button class="w3-button w3-block w3-teal" name="submit" id="insert">Save</button>
          <br><br>
          <a href="/petro/workexperience.php" class="w3-button w3-block w3-theme">Proceed</a>
...
<script type="text/javascript">
        document.getElementById("addressline1").value = getSavedValue("addressline1");    // set the value to this input
        document.getElementById("addressline2").value = getSavedValue("addressline2");   // set the value to this input
        ...
        document.getElementById("mobile").value = getSavedValue("mobile");
